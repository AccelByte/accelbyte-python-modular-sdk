...
platform-update-item-purchase-condition 'nzS9SiGUjVAw4v3q' '6JRHcn7KaoCEkRdo' --body '{"purchaseCondition": {"conditionGroups": [{"operator": "or", "predicates": [{"anyOf": 33, "comparison": "isGreaterThan", "name": "YIZWnXqQ1oHFJ9Q0", "predicateType": "SeasonPassPredicate", "value": "XegSEhrPpK2q8kxR", "values": ["4BuEksS2A9VOA8H9", "EuGJVl8xs1WId9Wl", "VeHv0L2Acm960EYQ"]}, {"anyOf": 1, "comparison": "is", "name": "HgoXCR6XOMXwKdfq", "predicateType": "EntitlementPredicate", "value": "xwEdkyuT3MgzReRq", "values": ["6bpuJip8JyxJ39vr", "6v2AEozWWaYvBLE4", "0112ISArROIodcmM"]}, {"anyOf": 40, "comparison": "isLessThan", "name": "mb01yA7U7dGMjupZ", "predicateType": "EntitlementPredicate", "value": "gwhYzk33J34fiTxK", "values": ["63OHpnUCGBVfpctN", "euLAbBgejqc0apxq", "FUsUQ6ZXQcb2o1J5"]}]}, {"operator": "or", "predicates": [{"anyOf": 49, "comparison": "includes", "name": "9BySn8aUaGlAyvIs", "predicateType": "EntitlementPredicate", "value": "SQdwec1m8BusV9tU", "values": ["h74KVo6Xqjz2xUKL", "aLMqi836ULa7cfZl", "NWSmYyVvyelIJ8Qg"]}, {"anyOf": 61, "comparison": "isLessThan", "name": "ErA82FrR1GSogkew", "predicateType": "SeasonTierPredicate", "value": "kIxXKKIR6kPmswm5", "values": ["LsGP6KLPXkvUv2Xi", "TCAU1cKApdJDnE73", "GLmSZns5owBhoUg4"]}, {"anyOf": 0, "comparison": "isGreaterThanOrEqual", "name": "BzsmaxjTZPlLityt", "predicateType": "SeasonTierPredicate", "value": "yB7FTexsOZ0b2p3b", "values": ["63KrcwIcXMhGy83X", "it6boOLGCcg16Dqw", "dQPQ9HkSSV8e1MgT"]}]}, {"operator": "and", "predicates": [{"anyOf": 91, "comparison": "includes", "name": "F3eTC0vzZUDj9dzG", "predicateType": "EntitlementPredicate", "value": "j7qms9AGQExPhgr9", "values": ["gGfC0GjvpgJfuBs1", "Onq9U5lyW89Xwt3w", "Vpqn47GVghTH2wTo"]}, {"anyOf": 26, "comparison": "isNot", "name": "RTrDCjhnKvsHezWT", "predicateType": "SeasonPassPredicate", "value": "WK0x0ZidAJ1CU1eD", "values": ["yGjjv4Mwrv2vancm", "R6Z7rb21A2E9pX0B", "1La16Bw3JbUnUDh5"]}, {"anyOf": 100, "comparison": "isNot", "name": "dzA8bvXlDhG7Bror", "predicateType": "EntitlementPredicate", "value": "SrSHrkoqv2mM6soM", "values": ["aTvQq2a9YdFNtRVS", "gUxAogcnGkXk17QP", "O0js0hG9xmSnzd7z"]}]}]}}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'platform-bulk-credit' \
    --body '[{"creditRequest": {"amount": 22, "expireAt": "1988-10-10T00:00:00Z", "origin": "GooglePlay", "reason": "aANvZ0I2EGVDWs67", "source": "PURCHASE"}, "currencyCode": "CeZXmSBfgrJcwR3q", "userIds": ["NSZTIlkM5IYJnbFp", "Uvez1lbenagh9kCP", "ktAdH94tziEpGVXs"]}, {"creditRequest": {"amount": 36, "expireAt": "1977-12-28T00:00:00Z", "origin": "GooglePlay", "reason": "WLjHPiPqvMMmYJeK", "source": "PROMOTION"}, "currencyCode": "dIk4I9TU6FvvEdqH", "userIds": ["zEDtl5oR9m1dm3fG", "40w6szojkvjtacFS", "K1wINqvFrAsrmYYu"]}, {"creditRequest": {"amount": 99, "expireAt": "1992-09-17T00:00:00Z", "origin": "Playstation", "reason": "UiqcJ2Jldy73ukTx", "source": "GIFT"}, "currencyCode": "3zAXk9qVrzEqsDwI", "userIds": ["wRyHKWspPtJlLDOj", "XTWGIrWq2VvH0roA", "20Sfzrc9YYsgvVLN"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'platform-bulk-debit' \
    --body '[{"currencyCode": "3usfhiyCf1FOddxt", "request": {"allowOverdraft": true, "amount": 14, "balanceOrigin": "GooglePlay", "reason": "2sFK1jNp3OwcrNR2"}, "userIds": ["vgYPIFEVZLGzEglE", "jH7Xx7m8IqIRyUqa", "CbbMa2LqgJOAfFwv"]}, {"currencyCode": "e95LWKrkj7TPuigp", "request": {"allowOverdraft": false, "amount": 18, "balanceOrigin": "Other", "reason": "JofgD4VypGT4cTfK"}, "userIds": ["QwS5kNxCPLeKM4cQ", "NrjPqUk0t9aquw2B", "2UVIQMA6BOpxtYbm"]}, {"currencyCode": "l8DlY91SXBeHwrkP", "request": {"allowOverdraft": true, "amount": 33, "balanceOrigin": "Epic", "reason": "7RKEcLehyAowu72o"}, "userIds": ["KCk0zbREElwdZORo", "O4pajEhkRLMvZnYZ", "CUdMES0mVVI1Filc"]}]' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
