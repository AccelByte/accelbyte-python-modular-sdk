...
social-bulk-get-stat-cycle-1 --body '{"cycleIds": ["afxMSJlHeb34sZKH", "ip68J1nsv4W2OJht", "cl5LLLOexL4fZvWt"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'social-bulk-get-stat-cycle' \
    --body '{"cycleIds": ["7fLD2qfCXnlUnqxT", "1WsRNMZcA92hzC7M", "Na8vVe4MHX6AgMep"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-update-stat' \
    'sxvaUoXDmwWsukxn' \
    --body '{"cycleIds": ["476dGGJwJ00UH197", "cuD3QxCXMd00YBWC", "aVVmM45mfIZsWhkS"], "defaultValue": 0.6281114473732753, "description": "J6zU7JLMQyMWzYQC", "ignoreAdditionalDataOnValueRejected": true, "isPublic": false, "name": "aPJgoxGJoJaSzUtY", "tags": ["sVY21NVIs7NRen2Y", "4ZD0Xtb0U4pH16NU", "3Ns0QJQeaWytPfds"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
