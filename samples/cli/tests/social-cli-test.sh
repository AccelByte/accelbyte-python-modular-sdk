...
social-bulk-get-stat-cycle --body '{"cycleIds": ["iI07A68eaqC2J9jy", "EW6GLbc0NaKDUL3s", "a13lk1dQBHO86IlB"]}' --login_with_auth "Bearer foo"
...
social-bulk-get-stat-cycle-1 --body '{"cycleIds": ["bjvqhnUVLWu8olKd", "xqGWV6mTJ0sQs6XN", "xL6ozRmDD0jJvlfV"]}' --login_with_auth "Bearer foo"
...
$PYTHON -m $MODULE 'social-create-stat' \
    --body '{"cycleIds": ["umnxAnYBTxaTIz0j", "VljdWYmELe74p38v", "cgDI8Pkz96vd80ms"], "defaultValue": 0.2588090843564592, "description": "Im5bufnBqrpLeqhw", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": false, "isPublic": false, "maximum": 0.8846290425603192, "minimum": 0.9782409461086465, "name": "FPwTiXfLcxDC9Ynd", "setAsGlobal": false, "setBy": "CLIENT", "statCode": "ECIQhfIhHtADUQ9z", "tags": ["imQTQT95pFJUAJsy", "u6opxQGRt6PqlkL0", "AfeKOufV4f15NohX"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-update-stat' \
    'gNEJBhgGq5GIDhNC' \
    --body '{"cycleIds": ["SSITz4TjCrJHXGXk", "66szbCCf73IFbRkP", "u2YVuOzhxHmnrrV9"], "defaultValue": 0.8351772558148868, "description": "GWrZ05sxe6A6RpmK", "ignoreAdditionalDataOnValueRejected": true, "isPublic": false, "name": "TKbonoucNmzwOZOK", "tags": ["56sDkci5rZ8iMlOu", "ksQJCiRFiZWwJ7Nr", "Tb1XTB9YQzUJ9XlY"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
...
$PYTHON -m $MODULE 'social-create-stat-1' \
    --body '{"cycleIds": ["vBVC5zgOKLTDmHe8", "c1eJ9sde7Ryt4udI", "v22M18uux9xBomQF"], "defaultValue": 0.6673150789352382, "description": "FWy5cwNPI6aFo0MV", "ignoreAdditionalDataOnValueRejected": true, "incrementOnly": true, "isPublic": true, "maximum": 0.09751849492857079, "minimum": 0.09072583511371801, "name": "OJDUT0uKAPrARya2", "setAsGlobal": false, "setBy": "CLIENT", "statCode": "M3bNLWHAbCZixe2c", "tags": ["Q6O30lpzcBQMAEcN", "iMY4H34B6wVd8ipc", "cJqrKxnMzSYoc4Zj"]}' \
    --login_with_auth "Bearer foo" \
    > test.out 2>&1
