...
dsartifact-delete-node-by-id 'ns0ZPqE9' 'DWBfVDuK' --login_with_auth "Bearer foo"
dsartifact-list-queue 'ep3g8xhq' --login_with_auth "Bearer foo"
dsartifact-get-active-queue 'v0fSldDo' --login_with_auth "Bearer foo"
dsartifact-set-active-queue 'LAUascDS' 'vACF42TP' --login_with_auth "Bearer foo"
dsartifact-delete-active-queue 'fiROfPIg' --login_with_auth "Bearer foo"
dsartifact-report-failed-upload 'bKuqbAQO' 'ndNBXWBI' --login_with_auth "Bearer foo"
dsartifact-delete-queue 'tQaNm9P5' 'E9SjQiEK' --login_with_auth "Bearer foo"
...
dsartifact-download-server-artifacts 'OoR7sIzI' --login_with_auth "Bearer foo"
dsartifact-check-server-artifact 'aHGz4osH' --login_with_auth "Bearer foo"
