...
from accelbyte_py_sdk.api.platform import public_get_user_entitlement_ownership_by_item_ids as public_get_user_entitlement_ownership_by_item_ids_internal
...
def public_get_user_entitlement_ownership_by_item_ids(
    ...
    if error:
        raise Exception(f"publicGetUserEntitlementOwnershipByItemIds failed: {str(error)}")
    click.echo(yaml.safe_dump(to_dict(result), sort_keys=False))


public_get_user_entitlement_ownership_by_item_ids.operation_id = "publicGetUserEntitlementOwnershipByItemIds"
