...
AccelByte Gaming Services provides [integration with OpenID Connect providers](https://docs.accelbyte.io/gaming-services/modules/foundations/identity-access/authentication/oidc-identity/) as one of the 3rd party login integration options.
