...
class ImportStoreResult(Model):
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> ImportStoreResult:
        instance = cls()
        if not dict_:
            return instance
        if "errors" in dict_ and dict_["errors"] is not None:
            instance.errors = [ImportStoreError.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["errors"]]
        elif include_empty:
            instance.errors = []
        if "storeInfo" in dict_ and dict_["storeInfo"] is not None:
            instance.store_info = StoreInfo.create_from_dict(dict_["storeInfo"], include_empty=include_empty)
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, ImportStoreResult]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[ImportStoreResult]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[ImportStoreResult, List[ImportStoreResult], Dict[Any, ImportStoreResult]]:
        if many:
