...
class EntitlementSoldResult(Model):
    ...
    def with_credit_summaries(self, value: List[CreditSummary]) -> EntitlementSoldResult:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "entitlement_info"):
            result["entitlementInfo"] = self.entitlement_info.to_dict(include_empty=include_empty)
        elif include_empty:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> EntitlementSoldResult:
        instance = cls()
        if not dict_:
            return instance
        ...
        if "entitlementInfo" in dict_ and dict_["entitlementInfo"] is not None:
            instance.entitlement_info = EntitlementInfo.create_from_dict(dict_["entitlementInfo"], include_empty=include_empty)
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, EntitlementSoldResult]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[EntitlementSoldResult]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[EntitlementSoldResult, List[EntitlementSoldResult], Dict[Any, EntitlementSoldResult]]:
        if many:
