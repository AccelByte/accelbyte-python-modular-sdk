...
class BulkCreditResult(Model):
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BulkCreditResult:
        instance = cls()
        if not dict_:
            return instance
        if "failList" in dict_ and dict_["failList"] is not None:
            instance.fail_list = [CreditResult.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["failList"]]
        elif include_empty:
            instance.fail_list = []
        ...
        if "successList" in dict_ and dict_["successList"] is not None:
            instance.success_list = [CreditResult.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["successList"]]
        elif include_empty:
            instance.success_list = []
        return instance

    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, BulkCreditResult]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[BulkCreditResult]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[BulkCreditResult, List[BulkCreditResult], Dict[Any, BulkCreditResult]]:
        if many:
