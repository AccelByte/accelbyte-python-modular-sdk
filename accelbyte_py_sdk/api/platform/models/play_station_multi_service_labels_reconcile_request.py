...
class PlayStationMultiServiceLabelsReconcileRequest(Model):
    ...
    def with_currency_code(self, value: str) -> PlayStationMultiServiceLabelsReconcileRequest:
    ...
    def with_product_id(self, value: str) -> PlayStationMultiServiceLabelsReconcileRequest:
        self.product_id = value
        return self

    def with_service_labels(self, value: List[int]) -> PlayStationMultiServiceLabelsReconcileRequest:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> PlayStationMultiServiceLabelsReconcileRequest:
        instance = cls()
        if not dict_:
            return instance
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, PlayStationMultiServiceLabelsReconcileRequest]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[PlayStationMultiServiceLabelsReconcileRequest]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[PlayStationMultiServiceLabelsReconcileRequest, List[PlayStationMultiServiceLabelsReconcileRequest], Dict[Any, PlayStationMultiServiceLabelsReconcileRequest]]:
        if many:
