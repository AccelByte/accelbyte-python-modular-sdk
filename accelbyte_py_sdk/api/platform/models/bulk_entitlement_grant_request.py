...
class BulkEntitlementGrantRequest(Model):
    ...
    def with_entitlement_grant_list(self, value: List[EntitlementGrant]) -> BulkEntitlementGrantRequest:
    ...
    def to_dict(self, include_empty: bool = False) -> dict:
        ...
        if hasattr(self, "entitlement_grant_list"):
            result["entitlementGrantList"] = [i0.to_dict(include_empty=include_empty) for i0 in self.entitlement_grant_list]
        elif include_empty:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> BulkEntitlementGrantRequest:
        instance = cls()
        if not dict_:
            return instance
        if "entitlementGrantList" in dict_ and dict_["entitlementGrantList"] is not None:
            instance.entitlement_grant_list = [EntitlementGrant.create_from_dict(i0, include_empty=include_empty) for i0 in dict_["entitlementGrantList"]]
        elif include_empty:
    ...
    @classmethod
    def create_many_from_dict(cls, dict_: dict, include_empty: bool = False) -> Dict[str, BulkEntitlementGrantRequest]:
        return {k: cls.create_from_dict(v, include_empty=include_empty) for k, v in dict_} if dict_ else {}

    @classmethod
    def create_many_from_list(cls, list_: list, include_empty: bool = False) -> List[BulkEntitlementGrantRequest]:
        return [cls.create_from_dict(i, include_empty=include_empty) for i in list_] if list_ else []

    @classmethod
    def create_from_any(cls, any_: any, include_empty: bool = False, many: bool = False) -> Union[BulkEntitlementGrantRequest, List[BulkEntitlementGrantRequest], Dict[Any, BulkEntitlementGrantRequest]]:
        if many:
