...
class GetIAPItemMapping(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, IAPItemMappingInfo], Union[None, ErrorEntity, HttpResponse]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetIAPItemMapping:
        instance = cls()
    ...
    def get_enum_map() -> Dict[str, List[Any]]:
        return {
            "platform": ["APPLE", "EPICGAMES", "GOOGLE", "PLAYSTATION", "STADIA", "STEAM", "TWITCH", "XBOX"],# in query
        }
