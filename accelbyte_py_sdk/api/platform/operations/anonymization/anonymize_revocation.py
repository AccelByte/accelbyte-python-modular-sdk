...
class AnonymizeRevocation(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/anonymization/revocation"
    _method: str = "DELETE"
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> AnonymizeRevocation:
        instance = cls()
