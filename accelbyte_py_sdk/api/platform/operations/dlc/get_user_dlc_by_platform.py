...
class GetUserDLCByPlatform(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, UserDLC], Union[None, HttpResponse]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserDLCByPlatform:
        instance = cls()
