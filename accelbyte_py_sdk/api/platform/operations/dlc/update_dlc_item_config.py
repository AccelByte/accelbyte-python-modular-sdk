...
class UpdateDLCItemConfig(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, DLCItemConfigInfo], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
