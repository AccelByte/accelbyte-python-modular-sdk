...
class ListViews(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[ListViewInfo]], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
