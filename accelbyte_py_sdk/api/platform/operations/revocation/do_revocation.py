...
class DoRevocation(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, RevocationResult], Union[None, HttpResponse]]:
    ...
    **kwargs
    ...
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> DoRevocation:
        ...
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = RevocationRequest.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
