...
class GetRevocationConfig(Operation):
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, RevocationConfigInfo], Union[None, ErrorEntity, HttpResponse]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetRevocationConfig:
        instance = cls()
