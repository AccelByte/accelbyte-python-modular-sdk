...
class UpdateItemTypeConfig(Operation):
    ...
    *  Returns : item type config data
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, ItemTypeConfigInfo], Union[None, ErrorEntity, HttpResponse, ValidationErrorEntity]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> UpdateItemTypeConfig:
        instance = cls()
        if "body" in dict_ and dict_["body"] is not None:
            instance.body = ItemTypeConfigUpdate.create_from_dict(dict_["body"], include_empty=include_empty)
        elif include_empty:
