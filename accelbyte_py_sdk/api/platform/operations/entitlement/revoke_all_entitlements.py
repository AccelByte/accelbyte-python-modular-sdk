...
class RevokeAllEntitlements(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/revoke"
    _method: str = "PUT"
    _consumes: List[str] = []
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> RevokeAllEntitlements:
        instance = cls()
