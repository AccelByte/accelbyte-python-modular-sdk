...
class GetUserActiveEntitlementsByItemIds(Operation):
    ...
    _url: str = "/platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemIds"
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Tuple[Union[None, List[EntitlementInfo]], Union[None, HttpResponse]]:
    ...
    **kwargs
    ...
    @classmethod
    def create_from_dict(cls, dict_: dict, include_empty: bool = False) -> GetUserActiveEntitlementsByItemIds:
        instance = cls()
