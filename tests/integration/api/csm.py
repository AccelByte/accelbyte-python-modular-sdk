...
class CSMTestCase(IntegrationTestCase):
    ...
    def test_csm(self):
        ...
        try:
            ...
            _, error = iam_service.admin_delete_client_v3(client_id=env_extend_app_client_id_value)
            self.assertIsNone(error, str(error))
            ...
            _, _ = iam_service.admin_delete_client_v3(client_id=env_extend_app_client_id_value)
