...
class RetrieveAllThirdPartyLoginPlatformCredentialV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/platforms/all/clients"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> RetrieveAllThirdPartyLoginPlatformCredentialV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveAllThirdPartyLoginPlatformCredentialV3.Response()
