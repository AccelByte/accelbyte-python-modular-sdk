...
class RetrieveActiveOIDCClientsPublicV3(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/platforms/clients/oidc"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> RetrieveActiveOIDCClientsPublicV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveActiveOIDCClientsPublicV3.Response()
