...
class RetrieveThirdPartyLoginPlatformCredentialV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/platforms/{platformId}/clients"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelThirdPartyLoginPlatformCredentialResponse] = None
        ...
        def ok(self) -> RetrieveThirdPartyLoginPlatformCredentialV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveThirdPartyLoginPlatformCredentialV3.Response()
