...
class RetrieveAllActiveThirdPartyLoginPlatformCredentialV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/platforms/all/clients/active"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelThirdPartyLoginPlatformCredentialResponse]] = None
        ...
        def ok(self) -> RetrieveAllActiveThirdPartyLoginPlatformCredentialV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveAllActiveThirdPartyLoginPlatformCredentialV3.Response()
