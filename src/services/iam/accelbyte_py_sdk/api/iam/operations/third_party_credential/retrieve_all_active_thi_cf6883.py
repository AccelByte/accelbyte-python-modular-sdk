...
class RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/platforms/clients/active"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelPublicThirdPartyPlatformInfo]] = None
        ...
        def ok(
            self,
        ) -> RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    ModelPublicThirdPartyPlatformInfo.create_from_dict(i)
                    for i in content
                ]
            elif code == 401:
