...
class AddThirdPartyLoginPlatformCredentialV3(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelThirdPartyLoginPlatformCredentialResponse] = None
        ...
        def ok(self) -> AddThirdPartyLoginPlatformCredentialV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AddThirdPartyLoginPlatformCredentialV3.Response()
