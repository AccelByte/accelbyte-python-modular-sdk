...
class AdminUpdateInputValidations(Operation):
    """[DEPRECATED] Admin Update Input Validations (AdminUpdateInputValidations)
    ...
    **Substitute endpoint:** /iam/v3/admin/namespaces/{namespace}/inputValidations[PUT]
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminUpdateInputValidations.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateInputValidations.Response()
