...
class AdminResetNamespaceScopedInputValidations(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/inputValidations/{field}"
    _base_path: str = ""
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminResetNamespaceScopedInputValidations.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminResetNamespaceScopedInputValidations.Response()
