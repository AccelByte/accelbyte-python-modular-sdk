...
class AdminGetNamespaceScopedInputValidations(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/inputValidations"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelInputValidationsResponse] = None
        error_401: Optional[RestErrorResponse] = None
        error_403: Optional[RestErrorResponse] = None

        def ok(self) -> AdminGetNamespaceScopedInputValidations.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetNamespaceScopedInputValidations.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelInputValidationsResponse.create_from_dict(
                    content
                )
            elif code == 401:
