...
class PublicGetNamespaceScopedInputValidationByField(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/inputValidations/{field}"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelInputValidationConfigVersion] = None
        error_404: Optional[HttpResponse] = None
        error_500: Optional[RestErrorResponse] = None

        def ok(self) -> PublicGetNamespaceScopedInputValidationByField.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetNamespaceScopedInputValidationByField.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelInputValidationConfigVersion.create_from_dict(
                    content
                )
            elif code == 404:
