...
class PublicGetNamespaceScopedInputValidations(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/inputValidations"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicGetNamespaceScopedInputValidations.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetNamespaceScopedInputValidations.Response()
