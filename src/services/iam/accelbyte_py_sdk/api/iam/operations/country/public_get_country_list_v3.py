...
class PublicGetCountryListV3(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/countries"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelCountryResponse]] = None
        error_500: Optional[RestErrorResponse] = None

        def ok(self) -> PublicGetCountryListV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetCountryListV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    ModelCountryResponse.create_from_dict(i) for i in content
                ]
            elif code == 500:
