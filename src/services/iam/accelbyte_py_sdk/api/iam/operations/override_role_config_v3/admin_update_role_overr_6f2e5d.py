...
class AdminUpdateRoleOverrideConfigV3(Operation):
    ...
    * only allow to add custom permission to additions.
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/roleoverride"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminUpdateRoleOverrideConfigV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateRoleOverrideConfigV3.Response()
