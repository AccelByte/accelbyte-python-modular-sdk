...
class NamespaceScopedPlatformTokenGrant(Operation):
    """[DEPRECATED] OAuth2 access token generation specific to platform (NamespaceScopedPlatformTokenGrant)
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/oauth/namespaces/{namespace}/platforms/{platformId}/token"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> NamespaceScopedPlatformTokenGrant.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = NamespaceScopedPlatformTokenGrant.Response()
