...
class RequestTokenExchangeCodeV3(Operation):
    ...
    _path: str = "/iam/v3/namespace/{namespace}/token/request"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[OauthmodelTargetTokenCodeResponse] = None

        def ok(self) -> RequestTokenExchangeCodeV3.Response:
            return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RequestTokenExchangeCodeV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = OauthmodelTargetTokenCodeResponse.create_from_dict(
                    content
                )
            else:
