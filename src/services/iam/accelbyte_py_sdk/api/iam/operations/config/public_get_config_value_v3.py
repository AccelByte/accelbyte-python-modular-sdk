...
class PublicGetConfigValueV3(Operation):
    ...
    * verificationCodeType
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelConfigValueResponseV3] = None
        error_400: Optional[RestErrorResponse] = None
        error_500: Optional[RestErrorResponse] = None

        def ok(self) -> PublicGetConfigValueV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetConfigValueV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelConfigValueResponseV3.create_from_dict(content)
            elif code == 400:
