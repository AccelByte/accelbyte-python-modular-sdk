...
class PlatformAuthenticateSAMLV3Handler(Operation):
    ...
    _path: str = "/iam/v3/sso/saml/platforms/{platformId}/authenticate"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PlatformAuthenticateSAMLV3Handler.Response:
            return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PlatformAuthenticateSAMLV3Handler.Response()
