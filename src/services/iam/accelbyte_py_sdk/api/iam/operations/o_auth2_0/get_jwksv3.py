...
class GetJWKSV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[OauthcommonJWKSet] = None

        def ok(self) -> GetJWKSV3.Response:
            return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = OauthcommonJWKSet.create_from_dict(content)
            else:
