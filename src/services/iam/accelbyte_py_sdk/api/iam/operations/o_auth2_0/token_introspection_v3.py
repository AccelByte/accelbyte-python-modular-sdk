...
class TokenIntrospectionV3(Operation):
    ...
    _path: str = "/iam/v3/oauth/introspect"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[OauthmodelTokenIntrospectResponse] = None
        error_400: Optional[OauthmodelErrorResponse] = None
        error_401: Optional[OauthmodelErrorResponse] = None

        def ok(self) -> TokenIntrospectionV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = TokenIntrospectionV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = OauthmodelTokenIntrospectResponse.create_from_dict(
                    content
                )
            elif code == 400:
