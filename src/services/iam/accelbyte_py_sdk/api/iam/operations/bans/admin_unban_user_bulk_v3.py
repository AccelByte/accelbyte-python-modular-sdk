...
class AdminUnbanUserBulkV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/bans/users/disabled"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelListBulkUserBanResponseV3] = None
        ...
        def ok(self) -> AdminUnbanUserBulkV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUnbanUserBulkV3.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelListBulkUserBanResponseV3.create_from_dict(
                    content
                )
            elif code == 400:
