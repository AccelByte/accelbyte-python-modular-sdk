...
class AdminGetBansTypeWithNamespaceV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/bantypes"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonBansV3] = None
        ...
        def ok(self) -> AdminGetBansTypeWithNamespaceV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetBansTypeWithNamespaceV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = AccountcommonBansV3.create_from_dict(content)
            elif code == 401:
