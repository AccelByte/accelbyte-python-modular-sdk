...
class PublicGetUserByPlatformUserIDV4(Operation):
    ...
    **Supported Platforms:**
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/platforms/{platformId}/users/{platformUserId}"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicGetUserByPlatformUserIDV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetUserByPlatformUserIDV4.Response()
