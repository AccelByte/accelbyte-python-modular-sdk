...
class PublicEnableMyBackupCodesV4(Operation):
    """[DEPRECATED] Enable 2FA backup codes (PublicEnableMyBackupCodesV4)
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/backupCode/enable"
    _base_path: str = ""
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelBackupCodesResponseV4] = None
        ...
        def ok(self) -> PublicEnableMyBackupCodesV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicEnableMyBackupCodesV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelBackupCodesResponseV4.create_from_dict(content)
            elif code == 400:
