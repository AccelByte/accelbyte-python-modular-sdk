...
class AdminGetUserMFAStatusV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/users/{userId}/mfa/status"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminGetUserMFAStatusV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetUserMFAStatusV4.Response()
