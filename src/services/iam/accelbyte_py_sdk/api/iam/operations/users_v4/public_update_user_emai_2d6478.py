...
class PublicUpdateUserEmailAddressV4(Operation):
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/email"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicUpdateUserEmailAddressV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicUpdateUserEmailAddressV4.Response()
