...
class PublicGenerateMyAuthenticatorKeyV4(Operation):
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/authenticator/key"
    _base_path: str = ""
    _method: str = "POST"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelAuthenticatorKeyResponseV4] = None
        ...
        def ok(self) -> PublicGenerateMyAuthenticatorKeyV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGenerateMyAuthenticatorKeyV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelAuthenticatorKeyResponseV4.create_from_dict(
                    content
                )
            elif code == 400:
