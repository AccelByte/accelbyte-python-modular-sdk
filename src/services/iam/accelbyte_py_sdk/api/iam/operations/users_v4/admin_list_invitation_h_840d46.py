...
class AdminListInvitationHistoriesV4(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelListInvitationHistoriesV4Response] = None
        ...
        def ok(self) -> AdminListInvitationHistoriesV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminListInvitationHistoriesV4.Response()
