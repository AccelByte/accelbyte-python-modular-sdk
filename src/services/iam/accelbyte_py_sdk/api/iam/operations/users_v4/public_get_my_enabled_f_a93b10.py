...
class PublicGetMyEnabledFactorsV4(Operation):
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/factor"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelEnabledFactorsResponseV4] = None
        ...
        def ok(self) -> PublicGetMyEnabledFactorsV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetMyEnabledFactorsV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelEnabledFactorsResponseV4.create_from_dict(
                    content
                )
            elif code == 400:
