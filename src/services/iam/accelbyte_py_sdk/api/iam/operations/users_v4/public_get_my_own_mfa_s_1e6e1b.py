...
class PublicGetMyOwnMFAStatusV4(Operation):
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/status"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelUserMFAStatusResponseV4] = None
        ...
        def ok(self) -> PublicGetMyOwnMFAStatusV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetMyOwnMFAStatusV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelUserMFAStatusResponseV4.create_from_dict(content)
            elif code == 401:
