...
class PublicRemoveTrustedDeviceV4(Operation):
    ...
    **(Test only)** Removes a trusted device. Requires a device_token cookie.
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/mfa/device"
    _base_path: str = ""
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicRemoveTrustedDeviceV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicRemoveTrustedDeviceV4.Response()
