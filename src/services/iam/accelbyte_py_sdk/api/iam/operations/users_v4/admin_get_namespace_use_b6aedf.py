...
class AdminGetNamespaceUserInvitationHistoryV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/invitationHistories/users"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelNamespaceInvitationHistoryUserV4Response] = None
        ...
        def ok(self) -> AdminGetNamespaceUserInvitationHistoryV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetNamespaceUserInvitationHistoryV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = (
                    ModelNamespaceInvitationHistoryUserV4Response.create_from_dict(
                        content
                    )
                )
            elif code == 400:
