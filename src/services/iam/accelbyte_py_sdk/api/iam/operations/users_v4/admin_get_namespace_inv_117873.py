...
class AdminGetNamespaceInvitationHistoryV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/invitationHistories"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelInvitationHistoryResponse] = None
        ...
        def ok(self) -> AdminGetNamespaceInvitationHistoryV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetNamespaceInvitationHistoryV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelInvitationHistoryResponse.create_from_dict(
                    content
                )
            elif code == 401:
