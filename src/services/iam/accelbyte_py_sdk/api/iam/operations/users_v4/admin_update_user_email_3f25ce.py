...
class AdminUpdateUserEmailAddressV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/users/{userId}/email"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminUpdateUserEmailAddressV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateUserEmailAddressV4.Response()
