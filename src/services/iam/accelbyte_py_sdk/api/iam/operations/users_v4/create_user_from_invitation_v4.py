...
class CreateUserFromInvitationV4(Operation):
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/invite/{invitationId}"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[AccountCreateUserResponseV4] = None
        ...
        def ok(self) -> CreateUserFromInvitationV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateUserFromInvitationV4.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = AccountCreateUserResponseV4.create_from_dict(content)
            elif code == 400:
