...
class AdminBulkUpdateUserAccountTypeV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/users/bulk/accountType"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminBulkUpdateUserAccountTypeV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminBulkUpdateUserAccountTypeV4.Response()
