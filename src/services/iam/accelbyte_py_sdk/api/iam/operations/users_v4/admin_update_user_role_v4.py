...
class AdminUpdateUserRoleV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/users/{userId}/roles"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelListUserRolesV4Response] = None
        ...
        def ok(self) -> AdminUpdateUserRoleV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateUserRoleV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelListUserRolesV4Response.create_from_dict(content)
            elif code == 400:
