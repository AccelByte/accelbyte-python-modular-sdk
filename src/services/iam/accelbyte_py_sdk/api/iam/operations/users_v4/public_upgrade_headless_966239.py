...
class PublicUpgradeHeadlessAccountV4(Operation):
    ...
    _path: str = "/iam/v4/public/namespaces/{namespace}/users/me/headless/verify"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountUserResponseV4] = None
        ...
        def ok(self) -> PublicUpgradeHeadlessAccountV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicUpgradeHeadlessAccountV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = AccountUserResponseV4.create_from_dict(content)
            elif code == 400:
