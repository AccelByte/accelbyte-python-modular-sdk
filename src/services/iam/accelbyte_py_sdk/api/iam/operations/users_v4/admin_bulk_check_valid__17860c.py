...
class AdminBulkCheckValidUserIDV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/users/bulk/validate"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelListValidUserIDResponseV4] = None
        ...
        def ok(self) -> AdminBulkCheckValidUserIDV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminBulkCheckValidUserIDV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelListValidUserIDResponseV4.create_from_dict(
                    content
                )
            elif code == 400:
