...
class AdminGetDeviceTypesV4(Operation):
    ...
    _path: str = "/iam/v4/admin/namespaces/{namespace}/devices/types"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelDeviceTypesResponseV4] = None
        ...
        def ok(self) -> AdminGetDeviceTypesV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetDeviceTypesV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelDeviceTypesResponseV4.create_from_dict(content)
            elif code == 401:
