...
class AdminCreateRoleV3(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[AccountcommonRoleV3] = None
        ...
        def ok(self) -> AdminCreateRoleV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminCreateRoleV3.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = AccountcommonRoleV3.create_from_dict(content)
            elif code == 400:
