...
class GetRoleAdminStatus(Operation):
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/roles/{roleId}/admin"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleAdminStatusResponse] = None
        ...
        def ok(self) -> GetRoleAdminStatus.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetRoleAdminStatus.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelRoleAdminStatusResponse.create_from_dict(content)
            elif code == 400:
