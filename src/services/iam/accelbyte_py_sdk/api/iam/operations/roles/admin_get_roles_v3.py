...
class AdminGetRolesV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleResponseWithManagersAndPaginationV3] = None
        ...
        def ok(self) -> AdminGetRolesV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetRolesV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = (
                    ModelRoleResponseWithManagersAndPaginationV3.create_from_dict(
                        content
                    )
                )
            elif code == 400:
