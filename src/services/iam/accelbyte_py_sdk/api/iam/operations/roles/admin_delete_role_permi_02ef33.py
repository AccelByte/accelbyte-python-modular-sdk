...
class AdminDeleteRolePermissionV3(Operation):
    ...
    _path: str = "/iam/v3/admin/roles/{roleId}/permissions/{resource}/{action}"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminDeleteRolePermissionV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminDeleteRolePermissionV3.Response()
