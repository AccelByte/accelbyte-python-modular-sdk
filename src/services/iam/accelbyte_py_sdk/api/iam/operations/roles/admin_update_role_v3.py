...
class AdminUpdateRoleV3(Operation):
    ...
    _path: str = "/iam/v3/admin/roles/{roleId}"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleResponseV3] = None
        ...
        def ok(self) -> AdminUpdateRoleV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateRoleV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelRoleResponseV3.create_from_dict(content)
            elif code == 400:
