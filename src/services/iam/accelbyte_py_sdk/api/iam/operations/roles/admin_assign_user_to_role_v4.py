...
class AdminAssignUserToRoleV4(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelAssignedUserV4Response] = None
        ...
        def ok(self) -> AdminAssignUserToRoleV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminAssignUserToRoleV4.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelAssignedUserV4Response.create_from_dict(content)
            elif code == 400:
