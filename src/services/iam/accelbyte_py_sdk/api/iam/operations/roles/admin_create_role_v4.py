...
class AdminCreateRoleV4(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelRoleV4Response] = None
        ...
        def ok(self) -> AdminCreateRoleV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminCreateRoleV4.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelRoleV4Response.create_from_dict(content)
            elif code == 400:
