...
class AdminUpdateRolePermissionsV4(Operation):
    ...
    _path: str = "/iam/v4/admin/roles/{roleId}/permissions"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleV4Response] = None
        ...
        def ok(self) -> AdminUpdateRolePermissionsV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateRolePermissionsV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelRoleV4Response.create_from_dict(content)
            elif code == 400:
