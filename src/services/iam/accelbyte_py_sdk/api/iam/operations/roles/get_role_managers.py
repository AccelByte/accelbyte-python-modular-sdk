...
class GetRoleManagers(Operation):
    ...
    **This endpoint is deprecated.**
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleManagersResponse] = None
        ...
        def ok(self) -> GetRoleManagers.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetRoleManagers.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelRoleManagersResponse.create_from_dict(content)
            elif code == 400:
