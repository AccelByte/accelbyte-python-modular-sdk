...
class AdminGetRoleMembersV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleMembersResponseV3] = None
        ...
        def ok(self) -> AdminGetRoleMembersV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetRoleMembersV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelRoleMembersResponseV3.create_from_dict(content)
            elif code == 400:
