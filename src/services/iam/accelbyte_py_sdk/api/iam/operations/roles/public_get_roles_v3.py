...
class PublicGetRolesV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelRoleNamesResponseV3] = None
        error_400: Optional[RestErrorResponse] = None

        def ok(self) -> PublicGetRolesV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetRolesV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelRoleNamesResponseV3.create_from_dict(content)
            elif code == 400:
