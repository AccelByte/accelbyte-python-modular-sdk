...
class AdminGetLoginAllowlistV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/loginAllowlist"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelLoginAllowlistResponse] = None
        ...
        def ok(self) -> AdminGetLoginAllowlistV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetLoginAllowlistV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelLoginAllowlistResponse.create_from_dict(content)
            elif code == 401:
