...
class AddSSOLoginPlatformCredential(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelSSOPlatformCredentialResponse] = None
        ...
        def ok(self) -> AddSSOLoginPlatformCredential.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AddSSOLoginPlatformCredential.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelSSOPlatformCredentialResponse.create_from_dict(
                    content
                )
            elif code == 400:
