...
class RetrieveAllSSOLoginPlatformCredentialV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/platforms/sso"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelSSOPlatformCredentialResponse]] = None
        ...
        def ok(self) -> RetrieveAllSSOLoginPlatformCredentialV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveAllSSOLoginPlatformCredentialV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    ModelSSOPlatformCredentialResponse.create_from_dict(i)
                    for i in content
                ]
            elif code == 401:
