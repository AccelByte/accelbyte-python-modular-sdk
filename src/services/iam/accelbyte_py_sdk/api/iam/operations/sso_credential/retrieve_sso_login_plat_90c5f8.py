...
class RetrieveSSOLoginPlatformCredential(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelSSOPlatformCredentialResponse] = None
        ...
        def ok(self) -> RetrieveSSOLoginPlatformCredential.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = RetrieveSSOLoginPlatformCredential.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelSSOPlatformCredentialResponse.create_from_dict(
                    content
                )
            elif code == 400:
