...
class AdminUpdateClientPermissionV3(Operation):
    ...
    * If the request body has new added/delete non-custom permission, the request will fail.
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/clients/{clientId}/permissions"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminUpdateClientPermissionV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateClientPermissionV3.Response()
