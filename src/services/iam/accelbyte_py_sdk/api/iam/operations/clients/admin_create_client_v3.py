...
class AdminCreateClientV3(Operation):
    ...
    * Fixed prefix custom permissions, the allowed prefix are:
    ...
    class Response(ApiResponse):
        data_201: Optional[ClientmodelClientV3Response] = None
        ...
        def ok(self) -> AdminCreateClientV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminCreateClientV3.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ClientmodelClientV3Response.create_from_dict(content)
            elif code == 400:
