...
class UpdateClient(Operation):
    ...
    **Endpoint migration guide**
    ...
    class Response(ApiResponse):
        data_200: Optional[ClientmodelClientResponse] = None
        ...
        def ok(self) -> UpdateClient.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ClientmodelClientResponse.create_from_dict(content)
            elif code == 400:
