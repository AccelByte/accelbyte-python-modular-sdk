...
class CreateClientByNamespace(Operation):
    ...
    **Note for Multi Tenant Mode (Confidential Client):**
    ...
    _path: str = "/iam/namespaces/{namespace}/clients"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[ClientmodelClientCreationResponse] = None
        ...
        def ok(self) -> CreateClientByNamespace.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateClientByNamespace.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ClientmodelClientCreationResponse.create_from_dict(
                    content
                )
            elif code == 400:
