...
class DeleteClientByNamespace(Operation):
    """[DEPRECATED] Delete Client (DeleteClientByNamespace)
    ...
    **Endpoint migration guide**
    ...
    _path: str = "/iam/namespaces/{namespace}/clients/{clientId}"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> DeleteClientByNamespace.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteClientByNamespace.Response()
