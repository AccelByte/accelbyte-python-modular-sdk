...
class AdminGetUserStateByUserIdV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/state"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelUserStateResponseV3] = None
        ...
        def ok(self) -> AdminGetUserStateByUserIdV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetUserStateByUserIdV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelUserStateResponseV3.create_from_dict(content)
            elif code == 400:
