...
class GetPublisherUser(Operation):
    """[DEPRECATED] Get Publisher User (GetPublisherUser)
    ...
    **Restriction:**
    ...
    _path: str = "/iam/namespaces/{namespace}/users/{userId}/publisher"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelGetPublisherUserResponse] = None
        ...
        def ok(self) -> GetPublisherUser.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetPublisherUser.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelGetPublisherUserResponse.create_from_dict(
                    content
                )
            elif code == 400:
