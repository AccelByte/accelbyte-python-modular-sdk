...
class AdminGetListJusticePlatformAccounts(Operation):
    ...
    **Namespace restriction:** The {namespace} path parameter must be a **publisher namespace**. Passing a game namespace returns HTTP 400.
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/justice"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelGetUserMapping]] = None
        ...
        def ok(self) -> AdminGetListJusticePlatformAccounts.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetListJusticePlatformAccounts.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    ModelGetUserMapping.create_from_dict(i) for i in content
                ]
            elif code == 400:
