...
class AdminUpdateAgeRestrictionConfigV2(Operation):
    """[DEPRECATED] Update age restriction config value (AdminUpdateAgeRestrictionConfigV2)
    ...
    **Endpoint migration guide**
    ...
    _path: str = "/iam/v2/admin/namespaces/{namespace}/agerestrictions"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelAgeRestrictionResponse] = None
        ...
        def ok(self) -> AdminUpdateAgeRestrictionConfigV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateAgeRestrictionConfigV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelAgeRestrictionResponse.create_from_dict(content)
            elif code == 400:
