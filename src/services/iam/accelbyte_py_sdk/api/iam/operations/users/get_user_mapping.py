...
class GetUserMapping(Operation):
    ...
    **This endpoint is deprecated.**
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelGetUserMapping] = None
        ...
        def ok(self) -> GetUserMapping.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetUserMapping.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelGetUserMapping.create_from_dict(content)
            elif code == 400:
