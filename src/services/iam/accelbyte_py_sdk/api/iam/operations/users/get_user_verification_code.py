...
class GetUserVerificationCode(Operation):
    ...
    **[WARNING] This API is only for testing purpose.**
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/codes"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelVerificationCodeResponse] = None
        ...
        def ok(self) -> GetUserVerificationCode.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetUserVerificationCode.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelVerificationCodeResponse.create_from_dict(
                    content
                )
            elif code == 401:
