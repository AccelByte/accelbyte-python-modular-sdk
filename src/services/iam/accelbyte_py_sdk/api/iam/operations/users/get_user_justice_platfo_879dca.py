...
class GetUserJusticePlatformAccount(Operation):
    """[DEPRECATED] Get the Justice linked accounts on the designated namespace (GetUserJusticePlatformAccount)
    ...
    **This endpoint is deprecated.**
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelGetUserJusticePlatformAccountResponse] = None
        ...
        def ok(self) -> GetUserJusticePlatformAccount.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetUserJusticePlatformAccount.Response()
