...
class AdminListUserAllPlatformAccountsDistinctV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/distinctPlatforms"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonDistinctPlatformResponseV3] = None
        ...
        def ok(self) -> AdminListUserAllPlatformAccountsDistinctV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminListUserAllPlatformAccountsDistinctV3.Response()
