...
class EnableUserBan(Operation):
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/namespaces/{namespace}/users/{userId}/bans/{banId}/enable"
    _base_path: str = ""
    _method: str = "PUT"
    _consumes: List[str] = ["*/*"]
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelUserBanResponse] = None
        ...
        def ok(self) -> EnableUserBan.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelUserBanResponse.create_from_dict(content)
            elif code == 401:
