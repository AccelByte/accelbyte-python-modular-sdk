...
class PublicUserVerificationV3(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/users/me/code/verify"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicUserVerificationV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicUserVerificationV3.Response()
