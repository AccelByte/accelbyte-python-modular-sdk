...
class PublicListUserIDByPlatformUserIDsV3(Operation):
    """[DEPRECATED] List User ID By Platform User ID (PublicListUserIDByPlatformUserIDsV3)
    ...
    **nintendo platform user ID**: NSA ID need to be appended with Environment ID using colon as separator. e.g kmzwa8awaa:dd1
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonUserPlatforms] = None
        ...
        def ok(self) -> PublicListUserIDByPlatformUserIDsV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicListUserIDByPlatformUserIDsV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = AccountcommonUserPlatforms.create_from_dict(content)
            elif code == 400:
