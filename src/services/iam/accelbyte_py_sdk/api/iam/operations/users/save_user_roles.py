...
class SaveUserRoles(Operation):
    """[DEPRECATED] Save User Roles (SaveUserRoles)
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/namespaces/{namespace}/users/{userId}/roles"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> SaveUserRoles.Response:
