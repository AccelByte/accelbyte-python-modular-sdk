...
class PublicGetCountryAgeRestriction(Operation):
    """[DEPRECATED] Public get age restriction by country code (PublicGetCountryAgeRestriction)
    ...
    **Endpoint migration guide**
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonCountry] = None
        error_401: Optional[RestErrorResponse] = None
        error_404: Optional[HttpResponse] = None

        def ok(self) -> PublicGetCountryAgeRestriction.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetCountryAgeRestriction.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = AccountcommonCountry.create_from_dict(content)
            elif code == 401:
