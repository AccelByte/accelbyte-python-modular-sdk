...
class UpgradeHeadlessAccountWithVerificationCode(Operation):
    """[DEPRECATED] Upgrade headless account and automatically verified the email address if it is succeeded (UpgradeHeadlessAccountWithVerificationCode)
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/namespaces/{namespace}/users/{userId}/upgradeHeadlessAccountWithVerificationCode"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> UpgradeHeadlessAccountWithVerificationCode.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UpgradeHeadlessAccountWithVerificationCode.Response()
