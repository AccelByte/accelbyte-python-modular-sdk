...
class PublicWebReauthPlatformEstablish(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/reauth/establish"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicWebReauthPlatformEstablish.Response:
            return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicWebReauthPlatformEstablish.Response()
