...
class AdminGetBulkUserByEmailAddressV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/search/bulk"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelListUserResponseV3] = None
        ...
        def ok(self) -> AdminGetBulkUserByEmailAddressV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetBulkUserByEmailAddressV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelListUserResponseV3.create_from_dict(content)
            elif code == 400:
