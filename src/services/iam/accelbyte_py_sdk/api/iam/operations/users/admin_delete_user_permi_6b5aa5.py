...
class AdminDeleteUserPermissionBulkV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/permissions"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminDeleteUserPermissionBulkV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminDeleteUserPermissionBulkV3.Response()
