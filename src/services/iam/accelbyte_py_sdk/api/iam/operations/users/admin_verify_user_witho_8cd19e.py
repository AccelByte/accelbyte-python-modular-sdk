...
class AdminVerifyUserWithoutVerificationCodeV3(Operation):
    ...
    **Note:**
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/verify"
    _base_path: str = ""
    _method: str = "PUT"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminVerifyUserWithoutVerificationCodeV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminVerifyUserWithoutVerificationCodeV3.Response()
