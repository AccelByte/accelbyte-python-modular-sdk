...
class AdminSendVerificationCodeV3(Operation):
    ...
    **_It is the default context if the Context field is empty_**
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/code/request"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminSendVerificationCodeV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminSendVerificationCodeV3.Response()
