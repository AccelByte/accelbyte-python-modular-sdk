...
class GetUserPlatformAccounts(Operation):
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/namespaces/{namespace}/users/{userId}/platforms"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[List[AccountcommonUserLinkedPlatform]] = None
        ...
        def ok(self) -> GetUserPlatformAccounts.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetUserPlatformAccounts.Response()
