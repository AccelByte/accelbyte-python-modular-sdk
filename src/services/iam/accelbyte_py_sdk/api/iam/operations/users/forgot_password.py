...
class ForgotPassword(Operation):
    """[DEPRECATED] Request Password Reset Code (ForgotPassword)
    ...
    **Special note for publisher-game scenario:** Game Client should provide game namespace path parameter and Publisher Client should provide publisher namespace path parameter.
    ...
    _path: str = "/iam/namespaces/{namespace}/users/forgotPassword"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> ForgotPassword.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = ForgotPassword.Response()
