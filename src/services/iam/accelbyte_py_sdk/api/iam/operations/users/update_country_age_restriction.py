...
class UpdateCountryAgeRestriction(Operation):
    ...
    **Endpoint migration guide**
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelCountry] = None
        ...
        def ok(self) -> UpdateCountryAgeRestriction.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UpdateCountryAgeRestriction.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelCountry.create_from_dict(content)
            elif code == 400:
