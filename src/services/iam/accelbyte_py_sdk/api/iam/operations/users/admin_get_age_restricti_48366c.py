...
class AdminGetAgeRestrictionStatusV2(Operation):
    """[DEPRECATED] Get age restriction status (AdminGetAgeRestrictionStatusV2)
    ...
    **Endpoint migration guide**
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminGetAgeRestrictionStatusV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetAgeRestrictionStatusV2.Response()
