...
class AdminLinkPlatformAccount(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/link"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminLinkPlatformAccount.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminLinkPlatformAccount.Response()
