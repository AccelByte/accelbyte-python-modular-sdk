...
class GetListCountryAgeRestriction(Operation):
    """[DEPRECATED] Get List Country age restriction (GetListCountryAgeRestriction)
    ...
    **Endpoint migration guide**
    ...
    _path: str = "/iam/v2/admin/namespaces/{namespace}/countries/agerestrictions"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetListCountryAgeRestriction.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    AccountcommonCountryAgeRestriction.create_from_dict(i)
                    for i in content
                ]
            elif code == 401:
