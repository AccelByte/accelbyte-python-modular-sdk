...
class AdminEnableUserV2(Operation):
    """[DEPRECATED] Enable a user (AdminEnableUserV2)
    ...
    **Endpoint migration guide**
    ...
    _path: str = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/enable"
    _base_path: str = ""
    _method: str = "PUT"
    _consumes: List[str] = ["*/*"]
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminEnableUserV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminEnableUserV2.Response()
