...
class GetAdminUsersByRoleIdV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/roles/{roleId}/users"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelGetUsersResponseWithPaginationV3] = None
        ...
        def ok(self) -> GetAdminUsersByRoleIdV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAdminUsersByRoleIdV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = (
                    ModelGetUsersResponseWithPaginationV3.create_from_dict(content)
                )
            elif code == 400:
