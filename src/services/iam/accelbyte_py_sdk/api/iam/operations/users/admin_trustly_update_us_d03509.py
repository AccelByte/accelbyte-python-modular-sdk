...
class AdminTrustlyUpdateUserIdentity(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/trustly/identity"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminTrustlyUpdateUserIdentity.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminTrustlyUpdateUserIdentity.Response()
