...
class PublicUpgradeHeadlessAccountV3(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/users/me/headless/code/verify"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicUpgradeHeadlessAccountV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicUpgradeHeadlessAccountV3.Response()
