...
class AdminUpdateAgeRestrictionConfigV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/agerestrictions"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelAgeRestrictionResponseV3] = None
        ...
        def ok(self) -> AdminUpdateAgeRestrictionConfigV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateAgeRestrictionConfigV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelAgeRestrictionResponseV3.create_from_dict(
                    content
                )
            elif code == 400:
