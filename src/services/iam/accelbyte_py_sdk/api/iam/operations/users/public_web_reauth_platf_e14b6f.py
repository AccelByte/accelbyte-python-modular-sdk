...
class PublicWebReauthPlatformProcess(Operation):
    ...
    _path: str = "/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}/web/reauth/process"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelWebReauthProcessResponse] = None
        error_400: Optional[RestErrorResponse] = None
        error_500: Optional[RestErrorResponse] = None

        def ok(self) -> PublicWebReauthPlatformProcess.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicWebReauthPlatformProcess.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelWebReauthProcessResponse.create_from_dict(
                    content
                )
            elif code == 400:
