...
class AdminGetUserBanV2(Operation):
    """[DEPRECATED] Get user's bans (AdminGetUserBanV2)
    ...
    **Endpoint migration guide**
    ...
    _path: str = "/iam/v2/admin/namespaces/{namespace}/users/{userId}/bans"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetUserBanV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    ModelUserBanResponse.create_from_dict(i) for i in content
                ]
            elif code == 401:
