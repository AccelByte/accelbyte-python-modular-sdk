...
class BanUser(Operation):
    """[DEPRECATED] Ban a single user (BanUser)
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/namespaces/{namespace}/users/{userId}/ban"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelUserBanResponse] = None
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelUserBanResponse.create_from_dict(content)
            elif code == 400:
