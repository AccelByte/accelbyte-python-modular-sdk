...
class AdminSearchUsersV2(Operation):
    """[DEPRECATED] Search Users (AdminSearchUsersV2)
    ...
    **Endpoint migration guide**
    ...
    _path: str = "/iam/v2/admin/namespaces/{namespace}/users"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelSearchUsersByPlatformIDResponse] = None
        ...
        def ok(self) -> AdminSearchUsersV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminSearchUsersV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelSearchUsersByPlatformIDResponse.create_from_dict(
                    content
                )
            elif code == 400:
