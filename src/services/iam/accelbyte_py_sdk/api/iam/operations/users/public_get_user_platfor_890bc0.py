...
class PublicGetUserPlatformAccountsV3(Operation):
    ...
    **Authentication:**
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonUserLinkedPlatformsResponseV3] = None
        ...
        def ok(self) -> PublicGetUserPlatformAccountsV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetUserPlatformAccountsV3.Response()
