...
class GetAdminInvitationV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelUserInvitationV3] = None
        error_404: Optional[RestErrorResponse] = None
        error_500: Optional[RestErrorResponse] = None

        def ok(self) -> GetAdminInvitationV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAdminInvitationV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelUserInvitationV3.create_from_dict(content)
            elif code == 404:
