...
class PublicGetLinkHeadlessAccountToMyAccountConflictV3(Operation):
    ...
    _path: str = "/iam/v3/public/users/me/headless/link/conflict"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelGetLinkHeadlessAccountConflictResponse] = None
        ...
        def ok(self) -> PublicGetLinkHeadlessAccountToMyAccountConflictV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetLinkHeadlessAccountToMyAccountConflictV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = (
                    ModelGetLinkHeadlessAccountConflictResponse.create_from_dict(
                        content
                    )
                )
            elif code == 400:
