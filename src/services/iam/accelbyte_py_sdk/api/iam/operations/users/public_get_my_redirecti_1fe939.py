...
class PublicGetMyRedirectionAfterLinkV3(Operation):
    ...
    _path: str = "/iam/v3/public/users/me/link/redirection"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetMyRedirectionAfterLinkV3.Response()
