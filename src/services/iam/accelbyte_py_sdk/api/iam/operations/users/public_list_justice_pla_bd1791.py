...
class PublicListJusticePlatformAccountsV3(Operation):
    ...
    **Authentication:**
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelGetUserMappingV3]] = None
        ...
        def ok(self) -> PublicListJusticePlatformAccountsV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicListJusticePlatformAccountsV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    ModelGetUserMappingV3.create_from_dict(i) for i in content
                ]
            elif code == 400:
