...
class PublicGetUserInformationV3(Operation):
    ...
    **Authentication:**
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonUserInformationV3] = None
        ...
        def ok(self) -> PublicGetUserInformationV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetUserInformationV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = AccountcommonUserInformationV3.create_from_dict(
                    content
                )
            elif code == 401:
