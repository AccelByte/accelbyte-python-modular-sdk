...
class AdminDeleteUserInformationV3(Operation):
    ...
    **WARNING:** Deletes user data directly from the database, bypassing the GDPR flow. Use with caution as this action is irreversible.
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/information"
    _base_path: str = ""
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminDeleteUserInformationV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminDeleteUserInformationV3.Response()
