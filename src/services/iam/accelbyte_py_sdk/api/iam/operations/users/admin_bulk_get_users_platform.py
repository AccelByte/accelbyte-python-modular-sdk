...
class AdminBulkGetUsersPlatform(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/bulk/platforms"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminBulkGetUsersPlatform.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminBulkGetUsersPlatform.Response()
