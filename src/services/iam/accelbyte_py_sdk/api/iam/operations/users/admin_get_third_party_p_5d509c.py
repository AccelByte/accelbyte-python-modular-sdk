...
class AdminGetThirdPartyPlatformTokenLinkStatusV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelTokenThirdPartyLinkStatusResponse] = None
        ...
        def ok(self) -> AdminGetThirdPartyPlatformTokenLinkStatusV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetThirdPartyPlatformTokenLinkStatusV3.Response()
