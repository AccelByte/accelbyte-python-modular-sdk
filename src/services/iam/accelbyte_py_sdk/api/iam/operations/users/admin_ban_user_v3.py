...
class AdminBanUserV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/{userId}/bans"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelUserBanResponseV3] = None
        ...
        def ok(self) -> AdminBanUserV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminBanUserV3.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelUserBanResponseV3.create_from_dict(content)
            elif code == 400:
