...
class CreateUser(Operation):
    """[DEPRECATED] Create User (CreateUser)
    ...
    **This endpoint is deprecated.**
    ...
    _path: str = "/iam/namespaces/{namespace}/users"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelUserCreateResponse] = None
        ...
        def ok(self) -> CreateUser.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelUserCreateResponse.create_from_dict(content)
            elif code == 400:
