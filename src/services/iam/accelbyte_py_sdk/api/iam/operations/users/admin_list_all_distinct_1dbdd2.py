...
class AdminListAllDistinctPlatformAccountsV3(Operation):
    ...
    _path: str = (
        "/iam/v3/admin/namespaces/{namespace}/users/{userId}/platforms/distinct"
    )
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminListAllDistinctPlatformAccountsV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminListAllDistinctPlatformAccountsV3.Response()
