...
class AdminListUsersV3(Operation):
    ...
    **Requires a publisher namespace.**
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/users/platforms/justice"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[AccountcommonListUsersWithPlatformAccountsResponse] = None
        ...
        def ok(self) -> AdminListUsersV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminListUsersV3.Response()
