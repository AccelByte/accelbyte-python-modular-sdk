...
class AdminUpdateProfileUpdateStrategyV3(Operation):
    ...
    _path: str = "/iam/v3/admin/namespaces/{namespace}/profileUpdateStrategies"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelSimpleProfileUpdateStrategyConfigs] = None
        ...
        def ok(self) -> AdminUpdateProfileUpdateStrategyV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateProfileUpdateStrategyV3.Response()
