...
class AdminListClientTemplates(Operation):
    ...
    _path: str = "/iam/v3/admin/clientConfig/templates"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ClientmodelListTemplatesResponse] = None
        error_401: Optional[RestErrorResponse] = None
        error_403: Optional[RestErrorResponse] = None

        def ok(self) -> AdminListClientTemplates.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminListClientTemplates.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ClientmodelListTemplatesResponse.create_from_dict(
                    content
                )
            elif code == 401:
