...
class CreateNewNoSQLDatabaseCredentialV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/nosql/credentials"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelNoSQLDatabaseCredentialResponse] = None
        ...
        def ok(self) -> CreateNewNoSQLDatabaseCredentialV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateNewNoSQLDatabaseCredentialV2.Response()
