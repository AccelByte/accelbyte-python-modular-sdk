...
class DeleteNoSQLDatabaseV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/nosql/databases"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelNoSQLDatabaseDeleteResponse] = None
        ...
        def ok(self) -> DeleteNoSQLDatabaseV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteNoSQLDatabaseV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelNoSQLDatabaseDeleteResponse.create_from_dict(
                    content
                )
            elif code == 400:
