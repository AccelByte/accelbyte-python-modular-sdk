...
class CreateNoSQLDatabaseV2(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelNoSQLDatabaseResponse] = None
        ...
        def ok(self) -> CreateNoSQLDatabaseV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateNoSQLDatabaseV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelNoSQLDatabaseResponse.create_from_dict(
                    content
                )
            elif code == 400:
