...
class DeleteNoSQLClusterV2(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelDeleteNoSQLResourceResponse] = None
        ...
        def ok(self) -> DeleteNoSQLClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteNoSQLClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelDeleteNoSQLResourceResponse.create_from_dict(
                    content
                )
            elif code == 401:
