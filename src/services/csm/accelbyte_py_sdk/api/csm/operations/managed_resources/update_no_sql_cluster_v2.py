...
class UpdateNoSQLClusterV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/nosql/clusters"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelNoSQLResourceResponse] = None
        ...
        def ok(self) -> UpdateNoSQLClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UpdateNoSQLClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelNoSQLResourceResponse.create_from_dict(
                    content
                )
            elif code == 400:
