...
class GetNoSQLAppListV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{studioName}/nosql/{resourceId}/apps"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelNoSQLAppListResponse] = None
        ...
        def ok(self) -> GetNoSQLAppListV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetNoSQLAppListV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelNoSQLAppListResponse.create_from_dict(content)
            elif code == 400:
