...
class DeleteKeyValueClusterV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/keyvalue/clusters/{resourceId}"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelKeyValueResourceResponse] = None
        ...
        def ok(self) -> DeleteKeyValueClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteKeyValueClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelKeyValueResourceResponse.create_from_dict(
                    content
                )
            elif code == 401:
