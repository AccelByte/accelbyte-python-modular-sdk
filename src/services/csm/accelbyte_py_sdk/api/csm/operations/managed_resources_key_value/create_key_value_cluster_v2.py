...
class CreateKeyValueClusterV2(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[ApimodelKeyValueResourceResponse] = None
        ...
        def ok(self) -> CreateKeyValueClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateKeyValueClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ApimodelKeyValueResourceResponse.create_from_dict(
                    content
                )
            elif code == 400:
