...
class GetKeyValueClusterLimitConfigV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/keyvalue/clusters/limitconfig"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[DomainKeyValueClusterConfig] = None
        ...
        def ok(self) -> GetKeyValueClusterLimitConfigV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetKeyValueClusterLimitConfigV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = DomainKeyValueClusterConfig.create_from_dict(content)
            elif code == 400:
