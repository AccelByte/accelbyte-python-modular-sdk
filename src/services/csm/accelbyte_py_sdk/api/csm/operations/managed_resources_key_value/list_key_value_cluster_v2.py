...
class ListKeyValueClusterV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/keyvalue/clusters"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelKeyValueResourceListResponse] = None
        ...
        def ok(self) -> ListKeyValueClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = ListKeyValueClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelKeyValueResourceListResponse.create_from_dict(
                    content
                )
            elif code == 400:
