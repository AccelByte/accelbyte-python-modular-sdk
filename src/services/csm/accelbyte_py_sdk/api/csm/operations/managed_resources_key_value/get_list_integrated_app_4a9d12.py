...
class GetListIntegratedAppKeyValueClusterV2(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelListIntegratedAppsKeyValueResponse] = None
        ...
        def ok(self) -> GetListIntegratedAppKeyValueClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetListIntegratedAppKeyValueClusterV2.Response()
