...
class GetIntegrationAppKeyValueClusterV2(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetIntegrationAppKeyValueResponse] = None
        ...
        def ok(self) -> GetIntegrationAppKeyValueClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetIntegrationAppKeyValueClusterV2.Response()
