...
class CreateKeyValueCredentialV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/keyvalue/credentials"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelCreateKeyValueCredentialResponse] = None
        ...
        def ok(self) -> CreateKeyValueCredentialV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateKeyValueCredentialV2.Response()
