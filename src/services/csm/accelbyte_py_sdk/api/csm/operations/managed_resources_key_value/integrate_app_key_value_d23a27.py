...
class IntegrateAppKeyValueClusterV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/keyvalue/integrations"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelIntegrateAppKeyValueResponse] = None
        ...
        def ok(self) -> IntegrateAppKeyValueClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = IntegrateAppKeyValueClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelIntegrateAppKeyValueResponse.create_from_dict(
                    content
                )
            elif code == 400:
