...
class GetListOfVariablesV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/variables"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetListOfConfigurationsV2Response] = None
        ...
        def ok(self) -> GetListOfVariablesV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetListOfVariablesV2.Response()
