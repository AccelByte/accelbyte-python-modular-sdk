...
class CreateAppUI(Operation):
    ...
    class Response(ApiResponse):
        data_201: Optional[ApimodelAppUIResponse] = None
        ...
        def ok(self) -> CreateAppUI.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ApimodelAppUIResponse.create_from_dict(content)
            elif code == 400:
