...
class GetSubscriptionV2Handler(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetNotificationSubscriberStatusResponse] = None
        ...
        def ok(self) -> GetSubscriptionV2Handler.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetSubscriptionV2Handler.Response()
