...
class CreateSQLDatabaseCredentialV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/sql/credentials"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelSQLDatabaseCredentialResponse] = None
        ...
        error_503: Optional[ResponseErrorResponse] = None

        def ok(self) -> CreateSQLDatabaseCredentialV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateSQLDatabaseCredentialV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = (
                    ApimodelSQLDatabaseCredentialResponse.create_from_dict(content)
                )
            elif code == 400:
                ...
                result.error_503 = ResponseErrorResponse.create_from_dict(content)
