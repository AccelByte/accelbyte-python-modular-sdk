...
class CreateSQLDatabaseV2(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelSQLDatabaseResponse] = None
        ...
        def ok(self) -> CreateSQLDatabaseV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateSQLDatabaseV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelSQLDatabaseResponse.create_from_dict(content)
            elif code == 400:
