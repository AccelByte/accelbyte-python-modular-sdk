...
class DeleteSQLClusterV2(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelDeleteSQLResourceResponse] = None
        ...
        def ok(self) -> DeleteSQLClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteSQLClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelDeleteSQLResourceResponse.create_from_dict(
                    content
                )
            elif code == 401:
