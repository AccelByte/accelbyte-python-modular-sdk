...
class UpdateSQLClusterV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/sql/clusters"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelSQLResourceResponse] = None
        ...
        def ok(self) -> UpdateSQLClusterV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UpdateSQLClusterV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelSQLResourceResponse.create_from_dict(content)
            elif code == 400:
