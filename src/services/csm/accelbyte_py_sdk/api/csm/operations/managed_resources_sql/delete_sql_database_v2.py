...
class DeleteSQLDatabaseV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/sql/databases"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelSQLDatabaseDeleteResponse] = None
        ...
        def ok(self) -> DeleteSQLDatabaseV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteSQLDatabaseV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelSQLDatabaseDeleteResponse.create_from_dict(
                    content
                )
            elif code == 400:
