...
class GetSQLAppListV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/sql/{resourceId}/apps"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelSQLAppListResponse] = None
        ...
        def ok(self) -> GetSQLAppListV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetSQLAppListV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelSQLAppListResponse.create_from_dict(content)
            elif code == 400:
