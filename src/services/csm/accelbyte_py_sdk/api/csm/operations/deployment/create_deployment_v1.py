...
class CreateDeploymentV1(Operation):
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/deployments"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[GeneratedCreateDeploymentV1Response] = None
        ...
        def ok(self) -> CreateDeploymentV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateDeploymentV1.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = GeneratedCreateDeploymentV1Response.create_from_dict(
                    content
                )
            elif code == 400:
