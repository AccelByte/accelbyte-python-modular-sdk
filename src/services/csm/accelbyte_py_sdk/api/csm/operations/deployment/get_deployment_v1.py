...
class GetDeploymentV1(Operation):
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/deployments/{deploymentId}"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedGetDeploymentV1Response] = None
        ...
        def ok(self) -> GetDeploymentV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetDeploymentV1.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedGetDeploymentV1Response.create_from_dict(
                    content
                )
            elif code == 401:
