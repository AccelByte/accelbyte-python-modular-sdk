...
class GetListOfDeploymentV1(Operation):
    """[DEPRECATED] Fetches the List of Deployments (GetListOfDeploymentV1)
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/deployments"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedGetDeploymentListV1Response] = None
        ...
        def ok(self) -> GetListOfDeploymentV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetListOfDeploymentV1.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedGetDeploymentListV1Response.create_from_dict(
                    content
                )
            elif code == 400:
