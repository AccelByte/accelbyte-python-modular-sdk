...
class GetAppDebugInfoV4(Operation):
    ...
    _path: str = "/csm/v4/admin/namespaces/{namespace}/apps/{app}/debuginfo"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelAppDebugInfoResponse] = None
        ...
        def ok(self) -> GetAppDebugInfoV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAppDebugInfoV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelAppDebugInfoResponse.create_from_dict(content)
            elif code == 400:
