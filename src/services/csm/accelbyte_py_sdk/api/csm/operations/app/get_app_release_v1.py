...
class GetAppReleaseV1(Operation):
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/release"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedGetAppReleaseV1Response] = None
        ...
        def ok(self) -> GetAppReleaseV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAppReleaseV1.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedGetAppReleaseV1Response.create_from_dict(
                    content
                )
            elif code == 401:
