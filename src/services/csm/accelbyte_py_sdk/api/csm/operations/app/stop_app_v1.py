...
class StopAppV1(Operation):
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/stop"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedStopAppV1Response] = None
        ...
        def ok(self) -> StopAppV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedStopAppV1Response.create_from_dict(content)
            elif code == 400:
