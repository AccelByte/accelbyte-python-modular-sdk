...
class UpdateAppV1(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedUpdateAppV1Response] = None
        ...
        def ok(self) -> UpdateAppV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedUpdateAppV1Response.create_from_dict(content)
            elif code == 400:
