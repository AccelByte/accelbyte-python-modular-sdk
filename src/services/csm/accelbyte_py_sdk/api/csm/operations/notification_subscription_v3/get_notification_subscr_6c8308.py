...
class GetNotificationSubscriberListV3(Operation):
    ...
    _path: str = "/csm/v3/admin/namespaces/{namespace}/apps/{app}/subscriptions"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetNotificationSubscriberListResponseV2] = None
        ...
        def ok(self) -> GetNotificationSubscriberListV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetNotificationSubscriberListV3.Response()
