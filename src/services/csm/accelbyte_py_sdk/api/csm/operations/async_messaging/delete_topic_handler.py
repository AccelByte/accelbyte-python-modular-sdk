...
class DeleteTopicHandler(Operation):
    ...
    _path: str = (
        "/csm/v2/admin/namespaces/{namespace}/asyncmessaging/topics/{topicName}"
    )
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelTopicResponse] = None
        ...
        def ok(self) -> DeleteTopicHandler.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteTopicHandler.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelTopicResponse.create_from_dict(content)
            elif code == 401:
