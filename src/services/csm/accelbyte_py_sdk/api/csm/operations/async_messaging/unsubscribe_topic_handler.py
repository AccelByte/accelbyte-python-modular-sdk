...
class UnsubscribeTopicHandler(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/asyncmessaging/topics/{topicName}/subscriptions"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelTopicSubscription] = None
        ...
        def ok(self) -> UnsubscribeTopicHandler.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UnsubscribeTopicHandler.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelTopicSubscription.create_from_dict(content)
            elif code == 401:
