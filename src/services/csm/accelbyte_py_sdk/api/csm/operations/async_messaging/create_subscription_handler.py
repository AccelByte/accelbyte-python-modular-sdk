...
class CreateSubscriptionHandler(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/asyncmessaging/topics/subscriptions"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelCreateSubscriptionResponse] = None
        ...
        def ok(self) -> CreateSubscriptionHandler.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateSubscriptionHandler.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelCreateSubscriptionResponse.create_from_dict(
                    content
                )
            elif code == 400:
