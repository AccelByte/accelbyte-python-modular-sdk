...
class GetAppImageListV1(Operation):
    """[DEPRECATED] Get a list of container images (GetAppImageListV1)
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/images"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedGetAppImageListV1Response] = None
        ...
        def ok(self) -> GetAppImageListV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAppImageListV1.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedGetAppImageListV1Response.create_from_dict(
                    content
                )
            elif code == 401:
