...
class GetAppImageListV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/images"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetAppImageListV2Response] = None
        ...
        def ok(self) -> GetAppImageListV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAppImageListV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelGetAppImageListV2Response.create_from_dict(
                    content
                )
            elif code == 401:
