...
class CreateAppV5(Operation):
    ...
    _path: str = "/csm/v5/admin/namespaces/{namespace}/apps/{app}"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelAppItemV5] = None
        ...
        def ok(self) -> CreateAppV5.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelAppItemV5.create_from_dict(content)
            elif code == 400:
