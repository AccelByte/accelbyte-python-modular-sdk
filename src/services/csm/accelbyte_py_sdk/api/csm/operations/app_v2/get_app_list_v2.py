...
class GetAppListV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetAppListV2Response] = None
        ...
        def ok(self) -> GetAppListV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelGetAppListV2Response.create_from_dict(content)
            elif code == 400:
