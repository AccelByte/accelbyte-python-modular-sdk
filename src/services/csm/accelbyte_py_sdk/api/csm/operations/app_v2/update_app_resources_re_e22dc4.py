...
class UpdateAppResourcesResourceLimitFormV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/resources/form"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> UpdateAppResourcesResourceLimitFormV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UpdateAppResourcesResourceLimitFormV2.Response()
