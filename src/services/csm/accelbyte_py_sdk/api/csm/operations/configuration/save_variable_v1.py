...
class SaveVariableV1(Operation):
    """[DEPRECATED] Save an environment variable (SaveVariableV1)
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/variables"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedSaveConfigurationV1Response] = None
        ...
        def ok(self) -> SaveVariableV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = SaveVariableV1.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = GeneratedSaveConfigurationV1Response.create_from_dict(
                    content
                )
            elif code == 400:
