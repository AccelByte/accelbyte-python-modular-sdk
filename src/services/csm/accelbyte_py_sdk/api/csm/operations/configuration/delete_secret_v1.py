...
class DeleteSecretV1(Operation):
    """[DEPRECATED] Delete an environment secret (DeleteSecretV1)
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/secrets/{configId}"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> DeleteSecretV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteSecretV1.Response()
