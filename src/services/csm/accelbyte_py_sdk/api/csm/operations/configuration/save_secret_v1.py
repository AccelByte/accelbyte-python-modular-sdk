...
class SaveSecretV1(Operation):
    """[DEPRECATED] Save an environment secret (SaveSecretV1)
    ...
    _path: str = "/csm/v1/admin/namespaces/{namespace}/apps/{app}/secrets"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> SaveSecretV1.Response:
