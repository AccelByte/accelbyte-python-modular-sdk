...
class GetListOfSecretsV1(Operation):
    """[DEPRECATED] Get list of environment secrets (GetListOfSecretsV1)
    ...
    class Response(ApiResponse):
        data_200: Optional[GeneratedGetListOfConfigurationsV1Response] = None
        ...
        def ok(self) -> GetListOfSecretsV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetListOfSecretsV1.Response()
