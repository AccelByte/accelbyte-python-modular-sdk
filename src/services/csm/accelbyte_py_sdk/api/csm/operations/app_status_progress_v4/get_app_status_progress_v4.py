...
class GetAppStatusProgressV4(Operation):
    ...
    _path: str = "/csm/v4/admin/namespaces/{namespace}/apps/{app}/status-progress"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetAppStatusProgressResponse] = None
        ...
        def ok(self) -> GetAppStatusProgressV4.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAppStatusProgressV4.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelGetAppStatusProgressResponse.create_from_dict(
                    content
                )
            elif code == 401:
