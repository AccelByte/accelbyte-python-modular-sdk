...
class GetListOfDeploymentV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/deployments"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetDeploymentListV2Response] = None
        ...
        def ok(self) -> GetListOfDeploymentV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetListOfDeploymentV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelGetDeploymentListV2Response.create_from_dict(
                    content
                )
            elif code == 400:
