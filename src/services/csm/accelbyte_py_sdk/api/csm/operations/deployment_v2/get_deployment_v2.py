...
class GetDeploymentV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/deployments/{deploymentId}"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelGetDeploymentListV2DataItem] = None
        ...
        def ok(self) -> GetDeploymentV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetDeploymentV2.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelGetDeploymentListV2DataItem.create_from_dict(
                    content
                )
            elif code == 401:
