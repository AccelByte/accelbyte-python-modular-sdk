...
class CreateDeploymentV2(Operation):
    ...
    _path: str = "/csm/v2/admin/namespaces/{namespace}/apps/{app}/deployments"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[ApimodelCreateDeploymentV2Response] = None
        ...
        def ok(self) -> CreateDeploymentV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateDeploymentV2.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ApimodelCreateDeploymentV2Response.create_from_dict(
                    content
                )
            elif code == 400:
