...
class AdminDeleteConfigurationAlertV1(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/alerts-configuration"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminDeleteConfigurationAlertV1.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminDeleteConfigurationAlertV1.Response()
