...
class AdminListEnvironmentVariables(Operation):
    ...
    _path: str = "/session/v1/admin/environment-variables"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelsEnvironmentVariableListResponse] = None
        error_401: Optional[ResponseError] = None
        error_403: Optional[ResponseError] = None

        def ok(self) -> AdminListEnvironmentVariables.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminListEnvironmentVariables.Response()
