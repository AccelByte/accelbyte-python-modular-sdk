...
class AdminGetListNativeSession(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/native-sessions"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelsNativeSessionPagingResponse] = None
        error_401: Optional[ResponseError] = None
        error_403: Optional[ResponseError] = None

        def ok(self) -> AdminGetListNativeSession.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminGetListNativeSession.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelsNativeSessionPagingResponse.create_from_dict(
                    content
                )
            elif code == 401:
