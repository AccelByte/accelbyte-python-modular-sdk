...
class PublicGetPartyPassword(Operation):
    ...
    _path: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/password"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelsGetPasswordResponse] = None
        ...
        def ok(self) -> PublicGetPartyPassword.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicGetPartyPassword.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelsGetPasswordResponse.create_from_dict(content)
            elif code == 400:
