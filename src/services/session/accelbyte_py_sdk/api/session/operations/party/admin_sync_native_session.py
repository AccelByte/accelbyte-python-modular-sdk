...
class AdminSyncNativeSession(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/users/{userId}/native-sync"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminSyncNativeSession.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminSyncNativeSession.Response()
