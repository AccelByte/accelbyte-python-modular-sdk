...
class PublicPartyCancel(Operation):
    ...
    _path: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/users/{userId}/cancel"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicPartyCancel.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicPartyCancel.Response()
