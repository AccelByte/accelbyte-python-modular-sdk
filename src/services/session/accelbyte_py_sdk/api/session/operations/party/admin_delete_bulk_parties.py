...
class AdminDeleteBulkParties(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/parties/bulk"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelsDeleteBulkPartySessionsAPIResponse] = None
        ...
        def ok(self) -> AdminDeleteBulkParties.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminDeleteBulkParties.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = (
                    ApimodelsDeleteBulkPartySessionsAPIResponse.create_from_dict(
                        content
                    )
                )
            elif code == 400:
