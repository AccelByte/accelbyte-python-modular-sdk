...
class AdminUploadPlatformCredentials(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/platform-credentials/{platformId}/upload"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminUploadPlatformCredentials.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUploadPlatformCredentials.Response()
