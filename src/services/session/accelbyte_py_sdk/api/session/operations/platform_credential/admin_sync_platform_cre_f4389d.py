...
class AdminSyncPlatformCredentials(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelsXblCertificateResponseBody] = None
        ...
        def ok(self) -> AdminSyncPlatformCredentials.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminSyncPlatformCredentials.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ApimodelsXblCertificateResponseBody.create_from_dict(
                    content
                )
            elif code == 400:
