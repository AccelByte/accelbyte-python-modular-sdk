...
class PublicUpdateInsertPartySessionStorage(Operation):
    ...
    _path: str = "/session/v1/public/namespaces/{namespace}/parties/{partyId}/storage/users/{userId}"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicUpdateInsertPartySessionStorage.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicUpdateInsertPartySessionStorage.Response()
