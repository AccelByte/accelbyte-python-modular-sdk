...
class AdminReadUserSessionStorage(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/sessions/{sessionId}/storage/users/{userId}"
    _base_path: str = ""
    _method: str = "GET"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminReadUserSessionStorage.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminReadUserSessionStorage.Response()
