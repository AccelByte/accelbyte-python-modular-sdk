...
class PublicUpdateInsertSessionStorageUserV2(Operation):
    ...
    _path: str = "/session/v2/public/namespaces/{namespace}/sessions/{sessionId}/storage/users/{userId}"
    _base_path: str = ""
    _method: str = "PATCH"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicUpdateInsertSessionStorageUserV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicUpdateInsertSessionStorageUserV2.Response()
