...
class PublicKickGameSessionMember(Operation):
    ...
    _path: str = "/session/v1/public/namespaces/{namespace}/gamesessions/{sessionId}/members/{memberId}/kick"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicKickGameSessionMember.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicKickGameSessionMember.Response()
