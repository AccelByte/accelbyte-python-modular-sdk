...
class AdminDeleteBulkGameSessions(Operation):
    ...
    _path: str = "/session/v1/admin/namespaces/{namespace}/gamesessions/bulk"
    _base_path: str = ""
    _method: str = "DELETE"
    ...
    class Response(ApiResponse):
        data_200: Optional[ApimodelsDeleteBulkGameSessionsAPIResponse] = None
        ...
        def ok(self) -> AdminDeleteBulkGameSessions.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminDeleteBulkGameSessions.Response()
