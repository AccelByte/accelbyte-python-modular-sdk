...
class ModelsNativeSessionSetting(Model):
    ...
    Properties:
        ...
        psn_disable_system_ui_menu: (PSNDisableSystemUIMenu) OPTIONAL Union[List[str], List[PSNDisableSystemUIMenuEnum]]
    ...
    psn_disable_system_ui_menu: Union[
        List[str], List[PSNDisableSystemUIMenuEnum]
    ]  # OPTIONAL
    ...
    def with_psn_disable_system_ui_menu(
        self, value: Union[List[str], List[PSNDisableSystemUIMenuEnum]]
    ) -> ModelsNativeSessionSetting:
    ...
    def create(
        ...
        psn_disable_system_ui_menu: Optional[
            Union[List[str], List[PSNDisableSystemUIMenuEnum]]
        ] = None,
