...
class AdminUpdateIntegrationConfiguration(Operation):
    ...
    _path: str = "/inventory/v1/admin/namespaces/{namespace}/integrationConfigurations/{integrationConfigurationId}"
    _base_path: str = ""
    _method: str = "PUT"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminUpdateIntegrationConfiguration.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminUpdateIntegrationConfiguration.Response()
