...
class UploadRevocationPluginConfigCertV2(Operation):
    ...
    _path: str = "/platform/admin/namespaces/{namespace}/revocation/plugins/revocation/customConfig/cert"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> UploadRevocationPluginConfigCertV2.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UploadRevocationPluginConfigCertV2.Response()
