...
class DeleteOculusSubscriptionGroup(Operation):
    ...
    _path: str = "/platform/admin/namespaces/{namespace}/iap/config/oculus/subscription/group/{sku}"
    _base_path: str = ""
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> DeleteOculusSubscriptionGroup.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteOculusSubscriptionGroup.Response()
