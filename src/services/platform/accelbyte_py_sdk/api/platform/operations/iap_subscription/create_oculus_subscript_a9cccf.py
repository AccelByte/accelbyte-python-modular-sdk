...
class CreateOculusSubscriptionGroup(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ThirdPartySubscriptionGroupInfo] = None
        error_409: Optional[ErrorEntity] = None

        def ok(self) -> CreateOculusSubscriptionGroup.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateOculusSubscriptionGroup.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ThirdPartySubscriptionGroupInfo.create_from_dict(
                    content
                )
            elif code == 409:
