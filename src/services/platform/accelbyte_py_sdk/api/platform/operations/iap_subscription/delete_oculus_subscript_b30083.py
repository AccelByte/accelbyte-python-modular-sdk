...
class DeleteOculusSubscriptionTier(Operation):
    ...
    _path: str = "/platform/admin/namespaces/{namespace}/iap/config/oculus/subscription/tier/{sku}"
    _base_path: str = ""
    _method: str = "DELETE"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> DeleteOculusSubscriptionTier.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = DeleteOculusSubscriptionTier.Response()
