...
class AddTierIntoMetaQuestSubscriptionGroup(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ThirdPartySubscriptionTierInfo] = None
        error_409: Optional[ErrorEntity] = None

        def ok(self) -> AddTierIntoMetaQuestSubscriptionGroup.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AddTierIntoMetaQuestSubscriptionGroup.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ThirdPartySubscriptionTierInfo.create_from_dict(
                    content
                )
            elif code == 409:
