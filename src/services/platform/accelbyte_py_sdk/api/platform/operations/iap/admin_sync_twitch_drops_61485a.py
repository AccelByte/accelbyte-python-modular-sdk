...
class AdminSyncTwitchDropsEntitlement(Operation):
    ...
    *  Returns :
    ...
    _path: str = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/twitch/sync"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> AdminSyncTwitchDropsEntitlement.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminSyncTwitchDropsEntitlement.Response()
