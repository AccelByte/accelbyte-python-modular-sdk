...
class SyncOculusSubscriptions(Operation):
    ...
    _path: str = "/platform/public/namespaces/{namespace}/users/{userId}/iap/oculus/subscription/sync"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> SyncOculusSubscriptions.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = SyncOculusSubscriptions.Response()
