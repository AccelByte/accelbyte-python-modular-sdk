...
class AdminSyncOculusSubscriptions(Operation):
    ...
    _path: str = "/platform/admin/namespaces/{namespace}/users/{userId}/iap/oculus/subscription/sync"
    _base_path: str = ""
    _method: str = "PUT"
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ThirdPartySubscriptionTransactionInfo]] = None
        error_400: Optional[ErrorEntity] = None
        error_404: Optional[ErrorEntity] = None

        def ok(self) -> AdminSyncOculusSubscriptions.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminSyncOculusSubscriptions.Response()
