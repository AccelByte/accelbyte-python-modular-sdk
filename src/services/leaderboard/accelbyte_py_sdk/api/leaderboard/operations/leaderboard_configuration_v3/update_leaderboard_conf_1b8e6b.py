...
class UpdateLeaderboardConfigurationAdminV3(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[ModelsGetLeaderboardConfigRespV3] = None
        ...
        def ok(self) -> UpdateLeaderboardConfigurationAdminV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = UpdateLeaderboardConfigurationAdminV3.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = ModelsGetLeaderboardConfigRespV3.create_from_dict(
                    content
                )
            elif code == 400:
