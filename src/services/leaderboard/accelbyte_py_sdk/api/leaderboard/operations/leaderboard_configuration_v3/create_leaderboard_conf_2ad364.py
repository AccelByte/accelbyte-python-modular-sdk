...
class CreateLeaderboardConfigurationAdminV3(Operation):
    ...
    _path: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_201: Optional[ModelsGetLeaderboardConfigRespV3] = None
        ...
        def ok(self) -> CreateLeaderboardConfigurationAdminV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = CreateLeaderboardConfigurationAdminV3.Response()
        ...
        if error is not None:
            ...
            if code == 201:
                result.data_201 = ModelsGetLeaderboardConfigRespV3.create_from_dict(
                    content
                )
            elif code == 400:
