...
class GetAllTimeLeaderboardRankingAdminV3(Operation):
    ...
    _path: str = "/leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/alltime"
    _base_path: str = ""
    _method: str = "GET"
    _consumes: List[str] = []
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> GetAllTimeLeaderboardRankingAdminV3.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetAllTimeLeaderboardRankingAdminV3.Response()
