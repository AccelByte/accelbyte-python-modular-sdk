...
class PublicSubmitMyHeadlessPersonalDataRequest(Operation):
    ...
    **Typically used by web portal** to invoke headless player GDPR using 3rd platform web authentication.
    ...
    _path: str = "/gdpr/public/users/me/headless/requests"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        ...
        def ok(self) -> PublicSubmitMyHeadlessPersonalDataRequest.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = PublicSubmitMyHeadlessPersonalDataRequest.Response()
