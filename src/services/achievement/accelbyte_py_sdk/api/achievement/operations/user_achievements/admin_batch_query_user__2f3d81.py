...
class AdminBatchQueryUserAchievements(Operation):
    ...
    _path: str = "/achievement/v1/admin/namespaces/{namespace}/users/{userId}/achievements/batchQuery"
    _base_path: str = ""
    _method: str = "POST"
    ...
    class Response(ApiResponse):
        data_200: Optional[List[ModelsUserAchievementResponse]] = None
        error_400: Optional[ResponseError] = None
        error_401: Optional[ResponseError] = None

        def ok(self) -> AdminBatchQueryUserAchievements.Response:
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = AdminBatchQueryUserAchievements.Response()
