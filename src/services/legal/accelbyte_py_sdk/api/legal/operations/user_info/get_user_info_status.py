...
class GetUserInfoStatus(Operation):
    ...
    class Response(ApiResponse):
        data_200: Optional[List[RetrieveUserInfoCacheStatusResponse]] = None

        def ok(self) -> GetUserInfoStatus.Response:
            return self
    ...
    def parse_response(self, code: int, content_type: str, content: Any) -> Response:
        ...
        """
        result = GetUserInfoStatus.Response()
        ...
        if error is not None:
            ...
            if code == 200:
                result.data_200 = [
                    RetrieveUserInfoCacheStatusResponse.create_from_dict(i)
                    for i in content
                ]
            else:
